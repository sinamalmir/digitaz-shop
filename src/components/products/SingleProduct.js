    ...
    return (
        <>
            ...
            <div className='md:px-4 lg:px-6 container mx-auto max-w-screen-2xl  grid grid-cols-12 grid-rows-[55px_minmax(500px,_1fr)] md:gap-6'>
                ...
                <div className="bg-white hidden md:block items-center col-span-8 lg:col-span-9 xl:col-span-10 rounded-lg">
                    <div className='bg-white px-4 items-center flex rounded-lg md:p-5'>
                         <Breadcrumb />
                    </div>
                </div>
                <div className="col-span-12 md:col-span-8 lg:col-span-9 xl:col-span-10 mt-3 md:mt-0">
                    <SinglePro />
                </div>
          </div>
        </>
